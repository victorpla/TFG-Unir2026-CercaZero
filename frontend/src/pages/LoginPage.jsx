  ...
  return (
    <section className="mx-auto flex min-h-[80vh] max-w-md flex-col justify-center px-6 py-10">
      <div className="mb-8 text-center">
        ...
        <h1 className="font-display text-2xl font-bold text-primary-900">Bienvenido/a de nuevo</h1>
        <p className="mt-1 text-sm text-primary-900/60">Inicia sesión para donar o reservar en tu barrio</p>
      </div>
